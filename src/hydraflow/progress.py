...
if __name__ == "__main__":
    ...
    # from hydraflow import multi_tasks_progress
    ...
    def parallel_progress_test():
        ...
        parallel_progress(func, it, *columns, n_jobs=4)
    ...
    #     [task(100), task(None)], main_description="transient", transient=True
    # )
    # multi_tasks_progress([task(100)], description="transient", transient=True)
